...
### DEPENDENCIES:
- PySCF, including all header files in pyscf/lib (most recently checked commit: 5368de502, v2.2.0)
- [pyscf-forge](https://github.com/pyscf/pyscf-forge) (most recently checked commit: 26122b84f)
