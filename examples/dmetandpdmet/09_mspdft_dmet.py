...
# LPDFT based on SA-CAS Calculation
weights=[0.5, 0.5]
...
mypdft.ci = mc.ci
mypdft = mypdft.multi_state(weights, "lin")
mypdft.kernel(mo_coeff=mo_coeff, dump_chk = False)
