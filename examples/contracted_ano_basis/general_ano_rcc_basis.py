...
# Example-1
mol1 = gto.M(atom='Fe 0 0 0; Xe 0 0 0; Cd 0 0 0', basis='ano', charge=2, verbose=0)
...
mol1 = gto.Mole(atom='Fe 0 0 0; Xe 0 0 0; Cd 0 0 0', charge=2, verbose=0)
...
mol1 = gto.Mole(atom='Fe 0 0 0; He 0 0 0; Mg 0 0 0', charge=2, verbose=0)
