...
def run_test(cre, norb, nelec, spin):
    ...
    _trans_rdm1hs(cre, cibra , ciket, norb, nelec, spin, None)

#run_test(0, norb, nelec, 0)
#run_test(0, norb, nelec, 1)
[run_test(cre, norb, nelec, spin) for cre in range(2) for spin in range(2)]
