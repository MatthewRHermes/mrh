...
PYBIND11_MODULE(libgpu, m) {
  ...
  m.def("compute_tdmhh_spin",&libgpu_compute_tdmhh_spin,"mrh/my_pyscf/fci/rdm.py::trans_rdmhh");
  m.def("compute_tdmhh_spin_v2",&libgpu_compute_tdmhh_spin_v2,"mrh/my_pyscf/fci/rdm.py::trans_rdmhh_v2");
