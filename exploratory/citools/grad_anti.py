...
def get_grad_exact(a_idxs, i_idxs, ham, las_rdm1, las_rdm2, las_rdm3, epsilon=0.0):
    ...
    print ("t1 gradients = ", grad_h1t1+grad_h2t1)
    print ("t2 gradients = ", grad_h1t2+grad_h2t2)

    #gradients = grad_h1t1+grad_h2t1 # t1 gradients
...
def get_rdm3_spin(rdm3):
    ...
    rdm3s = rdm3s - rdm3s.transpose(0,3,2,1,4,5) + rdm3s.transpose(0,3,2,5,4,1) - rdm3s.transpose(0,5,2,3,4,1) + rdm3s.transpose(0,5,2,1,4,3) - rdm3s.transpose(0,1,2,5,4,3)
...
def get_grad_h1t1(a_idxs, i_idxs, las_rdm1, h1):
    ...
    #print ("Term1 h1t1 = ", term1)
    #print ("Term2 h1t1 = ", term2)
...
def get_grad_h2t1(a_idxs, i_idxs, las_rdm2, h2):
    ...
    #print ("Term1 h2t1 = ", term1)
    #print ("Term2 h2t1 = ", term2)
...
def get_grad_h2t2(a_idxs, i_idxs, las_rdm2, las_rdm3, h2):
    ...
    print ("2rdm terms = ", sum_h2t2_2rdm)
    ...
    print ("3rdm terms = ", sum_h2t2_3rdm)
    ...
    for b,z in zip(t2a,t2i):
        ...
        #print ("indices 2rdm = ", x,y,"->",u,v, sum_h2t2_2rdm[u,x,v,y])
        #print ("indices 3rdm = ", x,y,"->",u,v, sum_h2t2_3rdm[u,x,v,y])
