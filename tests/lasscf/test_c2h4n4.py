...
mf_symm_df = mf_symm.density_fit (auxbasis = df.aug_etb (mol_symm)).run ()

def tearDownModule():
    global mol, mf, mf_df, mol_hs, mf_hs, mf_hs_df, mol_symm, mf_symm, mf_symm_df
    mol.stdout.close ()
    mol_hs.stdout.close ()
    del mol, mf, mf_df, mol_hs, mf_hs, mf_hs_df, mol_symm, mf_symm, mf_symm_df
