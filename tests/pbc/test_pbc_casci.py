...
'''
# Test-0: Construct the random but hermitian h1, h2 and use that to compute the FCI energy using real FCI code 
...
# Test-2: For more than one k-point, I will compare the results to the HF limit limit.
'''
