...
"""Tests for k-LASSCF CI updates and Hessian responses.

These tests cover combined orbital/CI updates, complex CI tangent rotations,
diagonal and off-diagonal CI Hessian actions, Hessian-diagonal assembly,
and complex gradient construction.
"""
