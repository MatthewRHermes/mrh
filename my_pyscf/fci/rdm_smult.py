...
def _transpose_mup_phh_0(dm_0, s, m):
    ...
    dm_1[:,0] = (((1 - 2*m)/(-3*m + s + 1)) * dm_0[:,0]
                 + ((-m + s)/(-3*m + s + 1)) * dm_0[:,1]
                 + ((m - s)/(-3*m + s + 1)) * dm_0[:,1].transpose (0,3,2,1))
...
def _transpose_mup_phh_1(dm_0, s, m):
    ...
    dm_1[:,0] = ((2*(m + s)/(3*m + s + 1)) * dm_0[:,0]
                 + ((m - s + 1)/(3*m + s + 1)) * dm_0[:,0].transpose (0,3,2,1)
...
def _transpose_mup_phh_2(dm_0, s, m):
    ...
    dm_1[:,0] = ((2*(m + s)/(3*m + s)) * dm_0[:,0]
                 + ((m - s)/(3*m + s)) * dm_0[:,1]
                 + ((-m + s)/(3*m + s)) * dm_0[:,1].transpose (0,3,2,1))
...
def _transpose_mdown_phh_2(dm_0, s, m):
    ...
    if round (m,1) == round (s,1):
        ...
        dm_1[:,0] = (((1/4)*(m + 3*s)/s) * dm_0[:,0]
                     + ((1/4)*(-m + s)/s) * dm_0[:,1]
                     + ((1/4)*(m - s)/s) * dm_0[:,1].transpose (0,3,2,1))
        dm_1[:,1] = (((1/4)*(-m + s)/s) * dm_0[:,0]
                     + ((1/4)*(m + 3*s)/s) * dm_0[:,1]
                     + ((1/4)*(-m + s)/s) * dm_0[:,1].transpose (0,3,2,1))
    return dm_1
def _transpose_mup_phh_3(dm_0, s, m):
    ...
    dm_1[:,0] = ((2*m/(3*m - s)) * dm_0[:,0]
                 + ((m - s)/(3*m - s)) * dm_0[:,0].transpose (0,3,2,1)
                 + ((m - s)/(3*m - s)) * dm_0[:,1])
    dm_1[:,1] = (((m - s)/(3*m - s)) * dm_0[:,0]
                 + ((-m + s)/(3*m - s)) * dm_0[:,0].transpose (0,3,2,1)
                 + (2*m/(3*m - s)) * dm_0[:,1])
...
def _transpose_mup_dm2_0(dm_0, s, m):
    ...
    dm_1[:,1] = (((1/2)*(m - s + 1)/m) * dm_0[:,0]
                 + (1) * dm_0[:,1]
                 + ((1/2)*(m - s + 1)/m) * dm_0[:,3])
    dm_1[:,2] = ((-1/2*(m - s + 1)/m) * dm_0[:,0].transpose (0,1,4,3,2)
                 + (1) * dm_0[:,2]
                 + (-1/2*(m - s + 1)/m) * dm_0[:,3].transpose (0,1,4,3,2))
    dm_1[:,3] = (((1/2)*(-m + s - 1)/m) * dm_0[:,0]
                 + ((1/2)*(m + s - 1)/m) * dm_0[:,3])
    return dm_1
def _transpose_mdown_dm2_0(dm_0, s, m):
    ...
    if round (m,1) == round (s - 1,1):
        ...
        dm_1[:,1] = ((1) * dm_0[:,1]
                     + ((1/2)*(-m + s - 1)/(s - 1)) * dm_0[:,3]
                     + ((1/2)*(-m + s - 1)/(s - 1)) * dm_0[:,0])
        dm_1[:,2] = ((1) * dm_0[:,2]
                     + (-1/2*(-m + s - 1)/(s - 1)) * dm_0[:,3].transpose (0,1,4,3,2)
...
def _transpose_mup_dm2_1(dm_0, s, m):
    ...
    dm_1[:,0] = (((1/2)*(-2*m**3 - 3*m**2*s + m*s + s**3 + s**2)/(m*(-3*m**2 + s**2 + s))) * dm_0[:,0]
                 ...
                 + ((1/2)*(-2*m**3 + 3*m**2*s + m*s - s**3 - s**2)/(m*(-3*m**2 + s**2 + s))) * dm_0[:,3]
                 + ((1/2)*(m**2 - s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,1].transpose (0,1,4,3,2)
                 + ((1/2)*(m**2 - s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,2].transpose (0,1,4,3,2))
    dm_1[:,1] = (((1/2)*(-m**2 + s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,0]
                 ...
                 + ((1/2)*(-m**2 + s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,3]
                 + ((1/2)*(-m**2 + s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,1].transpose (0,1,4,3,2)
                 + ((1/2)*(-m**2 + s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,2].transpose (0,1,4,3,2))
    dm_1[:,2] = ((-1/2*(-m**2 + s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,0].transpose (0,1,4,3,2)
                 + ((1/2)*(-2*m**3 - 3*m**2*s + m*s + s**3 + s**2)/(m*(-3*m**2 + s**2 + s))) * dm_0[:,2]
                 + ((1/2)*(-2*m**3 + 3*m**2*s + m*s - s**3 - s**2)/(m*(-3*m**2 + s**2 + s))) * dm_0[:,1]
                 + (-1/2*(-m**2 + s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,3].transpose (0,1,4,3,2)
                 + ((1/2)*(-m**2 + s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,2].transpose (0,1,4,3,2)
                 + ((1/2)*(-m**2 + s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,1].transpose (0,1,4,3,2))
    dm_1[:,3] = (((1/2)*(-2*m**3 + 3*m**2*s + m*s - s**3 - s**2)/(m*(-3*m**2 + s**2 + s))) * dm_0[:,0]
                 + ((1/2)*(-m**2 + s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,1]
                 + ((1/2)*(-m**2 + s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,2]
                 + ((1/2)*(-2*m**3 - 3*m**2*s + m*s + s**3 + s**2)/(m*(-3*m**2 + s**2 + s))) * dm_0[:,3]
                 + ((1/2)*(m**2 - s**2)/(-3*m**2 + s**2 + s)) * dm_0[:,1].transpose (0,1,4,3,2)
...
def _transpose_mdown_dm2_1(dm_0, s, m):
    ...
    if round (m,1) == round (s,1):
        ...
        dm_1[:,0] = (((1/2)*(m**2 - 2*m*s + m + s**2 - s)/(s*(2*s - 1))) * dm_0[:,3]
