...
class CASSCF(newton_sacasscf.CASSCF):
    __doc__ = newton_sacasscf.CASSCF.__doc__
    def __init__(self, mf_or_mol, ncas, nelecas, ncore=None, frozen=None):
        newton_sacasscf.CASSCF.__init__(self, mf_or_mol, ncas, nelecas, ncore, frozen)
    ...
    def kernel(self, mo_coeff=None, ci0=None, callback=None, _kern=None):
        ...
        if _kern is None: _kern = newton_sacasscf.kernel
...
# elements.
    ...
    def rotate_mo(self, mo, u, log=None):
        ...
        mo = newton_sacasscf.CASSCF.rotate_mo(self, mo, u, log)
