...
# As it doesn't support complex numbers. However, The block2 is really good in handling
# various types of Hamiltonians symmetries. I am writing an interface with the SU2 symmetry
# along with the complex numbers. In the limit of bond dimension going to infinity this 
# would be equivalent to the exact FCI with complex integrals. I have structured most of 
# these functions similar to the ones in pyscf+dmrgscf+block2, so that it would be easier 
